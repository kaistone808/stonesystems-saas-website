...
export function ValuesSection() {
  return (
    <>
      <Container size="lg">
        <Title className={classes.mainTitle}>We are deliberate in every aspect of our culture.</Title>
        <SimpleGrid cols={2}>
          <div>
            <Flex className={classes.aboutValue}>
              ...
              <div>
                ...
                <Text c="dimmed" className={classes.aboutDescription}>
                  We’re a team of passionate professionals who truly care for our work and for each
                  other.
                </Text>
              </div>
            </Flex>
            <Flex className={classes.aboutValue}>
              <Image w={80} h={55} mt={'xl'} mr={'lg'} src="/images/icon2.webp" alt="Contractor" />
              <div>
                <Title order={3} className={classes.aboutTitle}>
                  Radical Integrity
                </Title>
            ...
            <Flex className={classes.aboutValue}>
              <Image w={80} h={55} mt={'xl'} mr={'lg'} src="/images/icon3.webp" alt="Contractor" />
              <div>
                <Title order={3} className={classes.aboutTitle}>
                  People First
                </Title>
            ...
            <Flex className={classes.aboutValue}>
              <Image w={80} h={55} mt={'xl'} mr={'lg'} src="/images/icon4.webp" alt="Contractor" />
              <div>
                <Title order={3} className={classes.aboutTitle}>
                  Process Perfection
                </Title>
            ...
            <Flex className={classes.aboutValue}>
              <Image w={80} h={55} mt={'xl'} mr={'lg'} src="/images/icon5.webp" alt="Contractor" />
              <div>
                <Title order={3} className={classes.aboutTitle}>
                  Empower One Another
                </Title>
