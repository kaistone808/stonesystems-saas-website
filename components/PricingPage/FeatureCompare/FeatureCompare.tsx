          ...
          <Accordion variant="separated">
            <Accordion.Item value="website">
              ...
              <Accordion.Panel>
                ...
                <List>
                  <List.Item>
                    Website chat that creates text conversations and instant sms confirmations sent
                    to your leads on autopilot
                  </List.Item>
                  <List.Item>
            ...
            <Accordion.Item value="mctb">
              ...
              <Accordion.Panel>
                ...
                <List>
                  ...
                  <List.Item>
                    67% of customers will go to a competitor if they don’t receive a quick response
                    to their missed call
                  </List.Item>
                  <List.Item>
                    67% of customers will go to a competitor if they don’t receive a quick response
                    to their missed call
